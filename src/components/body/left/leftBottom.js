...
<Box sx={{
    ...
    alignItems: "center"
      ...
      <img src="https://media.licdn.com/dms/image/C560EAQG85zEEe9AsAw/rightRail-logo-shrink_200_200/0/1631001603439?e=1680940800&v=beta&t=DkRx82SWPhVgGanUSNCbtfCL7XjXEYgUtOeqUmkA-u0" style={{width: "70px"}} />
     <p>Find a company that needs your skills.</p>
     <Button size="small" variant="outlined" className="blueBtn" sx={{    width: "40%"}}>
        Search Jobs
        </Button>
           
      </Box>
<hr />
<p style={{color:"#0a66c2",textAlign:"center",    fontSize: "16px",
    fontWeight: "700",
    margin: "0.5em"}}>Grow Your Network</p>
<hr />
<Box>
<Box className="footerDIv">
    ...
    <p>
    Privacy & Terms <ArrowDropDownIcon  style={{
    fontSize: "17px"
}}/>
    </p>
    </Box>
    ...
    <Box className="footerDIv">
    <p>
    Business Services <ArrowDropDownIcon style={{
    fontSize: "17px"
}} />
    </p>
    </Box>
    ...
    <Box className="footerDIv" sx={{marginTop:"18px"}}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 14" data-supported-dps="56x14" fill="currentColor" className="mercado-match" width="56" height="14" focusable="false" style={{color:"#1976d2",marginRight:"5px"}}>
  <g>
